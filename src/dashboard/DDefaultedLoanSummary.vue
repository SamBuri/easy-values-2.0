<script setup>
   ...
   const loanStore = defineLoanStore();
    ...
    const dashboardList = computed(()=>loanStore.loanSummary.filter(l=>l.loanStatus=='Defaulted'));
...
export default {
    ...
    computed: {
        ...
        dashboardList() {
            return this.$store.state.loan.loan.loanSummary.filter(l => l.loanStatus == 'Defaulted');
        },
