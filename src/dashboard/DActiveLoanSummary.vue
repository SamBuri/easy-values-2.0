<template>
  <s-data-dashboard  title="Active Loan Summary" :headers="headers" :data="dashboardList"> </s-data-dashboard>
</template>

<script>
import funcs from '../utils/funcs'
export default {
  name: 'DActiveLoanSummary',
  props: ["title"],
  data: () => ({

    headers: [{title: "Product Name", key: "productName", chartLabel:true},
  ...
  computed: {
    ...
    dashboardList() {
      return this.$store.state.loan.loan.loanSummary.filter(l=>l.loanStatus=='Active');
    },
