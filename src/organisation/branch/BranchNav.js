...
const branchNav = {
  ...
  menu: {
    ...
    children: [
      {
        id: "organisation.branch.view",
        title: "View",
        to: { name: "branches" },
      },
      {
        id: "organisation.branch.new",
        title: "New",
        to: { name: "branch", params: { mode: 0 } },
      },
      {
        id: "organisation.branch.edit",
        title: "Edit",
        to: { name: "branch", params: { mode: 1 } },
      },
      {
        id: "organisation.branch.history",
        title: "History",
        to: { name: "branch", params: { mode: 2 } },
      },
    ],
  },
};
