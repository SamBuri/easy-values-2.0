...
const accountsNavData = {
  ...
  nav: {
    ...
    requires: [
      ...financialPeriodNav.menu.requires,
      ...accountCategoryNav.menu.requires,
      ...accountNav.menu.requires,
      // ...businessSectionAccountNav.menu.requires,
      ...journalNav.menu.requires,
      ...generalLedgerNav.menu.requires,
      ...accountLedgerNav.menu.requires,
      ...incomestatementNav.menu.requires,
      ...balanceSheetNav.menu.requires,
