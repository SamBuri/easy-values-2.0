<template>
  <div>
    ...
    <crud-form @save="save" @update="update" @search="search" @updateDialog="updateDialog" @reset="reset" @done="done"
      ...
      :path="path" :maxWidth="maxWidth" :inner="inner">
      <template slot="heading">Profile
      ...
      <template slot="form-data" slot-scope="{ isUpdate }">
        ...
        <v-col :cols="cols" :sm="sm" :md="md">
          <v-select label="Profile Type" v-model="profile.profileType" :rules="profileTypeRules" :counter="10" required
        ...
        <v-col :cols="cols" :sm="cols" :md="cols">
          <s-file-input v-model="profile.photo" label="Photo" :disabled="isUpdate" />
        </v-col>
        ...
        <template v-if="isIndividual">
          ...
          <v-col :cols="cols" :sm="sm" :md="md">
            <v-select label="Occupation" v-model="profile.occupationId" :rules="occupationIdRules" :counter="100" required
...
export default {
  ...
  data: () => ({
    ...
    //   (v) =>
    //     v.length < 100 || "Spouse Name length must be less or equal to 100",
    // ],
    // spouseContactRules: [
    //   (v) => !!v || "Spouse Contact is required",
    //   (v) =>
    //     v.length < 100 || "Spouse Contact length must be less or equal to 100",
    // ],
    // nOKinRules: [
    //   (v) => !!v || "NO Kin is required",
    //   (v) => v.length < 100 || "NO Kin length must be less or equal to 100",
    // ],
    // nOKinContactRules: [
    //   (v) => !!v || "NO Kin Contact is required",
    //   (v) =>
    //     v.length < 100 || "NO Kin Contact length must be less or equal to 100",
    // ],
    ...
    maritalStatusIdRules: [(v) => !!v || "Marital Status is required"],
    idTypeIdRules: [(v) => !!v || "Id Type is required"],
    idNoRules: [
  ...
  watch: {
    // countryObj() {
    //   if (this.countryObj) {
    //     this.profile.countryId = this.countryObj.id;
    //     this.profile.country = this.countryObj.countryName;
    //   } else {
