...
const subCountyNav = {
        ...
        // ],
        routes: navUtils.allRoutes("subcounty", SubCounty, "subcounties", SubCounties, true),
        menu: {
                id: "profile.subcounty",
                title: "Sub Counties",
                component: SubCounty,
                path: "subcounties",
                icon: "mdi-map-marker",
                requires: navUtils.allRoles("subcounty"),
                width: "700px",
                ...
                // ]
                children: navUtils.allChildren('profile', 'subcounty', 'subcounties', false),
        }
}
