...
const parishNav = {
        ...
        // ],
        routes: navUtils.allRoutes("parish", Parish, "parishes", Parishes, true),
        menu: {
                id: "profile.parish",
                title: "Parishes",
                component: Parish,
                path: "parishes",
                requires: navUtils.allRoles("parish"),
                ...
                // ]
                children: navUtils.allChildren('profile', 'parish', 'parishes', false),
        }
}
