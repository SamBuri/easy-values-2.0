...
const villageNav = {
        ...
        // ],
        routes: navUtils.allRoutes("village", Village, "villages", Villages, true),
        menu: {
                id: "profile.village",
                title: "Villages",
                component: Village,
                path: "villages",
                icon: "mdi-home-city",
                requires: navUtils.allRoles("village"),
                width: "700px",
                ...
                // ]
                children: navUtils.allChildren('profile', 'village', 'villages', false),
        }
}
